...
def scrape(filename, lang):
    ...
    duration = soup.find(
        "img",
        {
            "src": "https://montrealfringe.online.red61.ca/wp-content/themes/red61-7.1.0/images/icon_duration.svg"
        },
    )
...
if __name__ == "__main__":
    ...
    all_performances = list(scrape_all(glob.glob("html-2024/*.html"), lang))
    json.dump(all_performances, open("performances-2024.json", "w"))
